    ...
    <Wrapper>
      <div className='flex-select'>
        ...
        <select
          ...
          onChange={(e) => {
            dispatch({
              type: 'UPDATE_QUIZ_CONFIG',
              payload: { name: name, newValue: e.target.value },
            });
          }}
        >
  ...
  .flex-select {
    ...
    select {
      ...
      background-color: ${({ theme }) =>
        theme.name === 'light' ? 'var(--select-input-bg-light)' : 'var(--select-input-bg-dark)'};
      ...
      border: ${({ theme }) =>
        theme.name === 'light' ? '1px solid var(--dark-gray)' : '0.5px solid var(--btn-text-disabled)'};
    }
  }
  .flex-questions {
    display: flex;
